        ...
        function comparation(){
            ...
            if(array1.length == 0){
              ...
              t.style.border = ` 2px solid white`
                ...
                var valor2 = window.document.createElement('p')
                valor3.innerHTML = `Infelizmente não foi dessa vez, tente novamente! \u{1F614}`
                answer.appendChild(valor3)
